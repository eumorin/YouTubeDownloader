    ...
    def fetch_video_info(self):
        try:
            ...
            if res.status_code != 200:
                ...
                filtered_streams_str = filtered_streams.__str__()
                ...
                if self.callback:
                    ...
                    return video_info, self.streams_dict
        except Exception as e:
            print(f"Error while fetching video info:\n{e}")
            return False
    ...
    def save_file(self, selected_format):
        ...
        if file_path:
            ...
            if file_extension == 'mp3':
                ...
                tmp_video_path = os.path.join(output_path, tmp_video_filename)
                ...
                tmp_audio_path = os.path.join(output_path, tmp_audio_filename)
                ...
                if os.path.exists(tmp_audio_path) and os.path.exists(tmp_video_path):
